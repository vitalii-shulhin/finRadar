...
export async function generateMetadata({ params }: { params: { lang: Locale } }): Promise<Metadata> {
  ...
  return {
    title: params.lang === 'uk'
      ...
      : 'OSAGO (Автоцивилка) в Запорожье - Онлайн Оформление Страховки | FinRadar',
    description: params.lang === 'uk'
      ...
      : 'Оформить OSAGO (Автоцивилку) в Запорожье онлайн. Сравнение цен от всех страховых компаний Запорожья. Электронный полис за 5 минут. Цены от 4 308 грн.',
