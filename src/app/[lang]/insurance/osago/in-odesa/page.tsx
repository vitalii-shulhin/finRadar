...
export async function generateMetadata({ params }: { params: { lang: Locale } }): Promise<Metadata> {
  ...
  return {
    title: params.lang === 'uk'
      ...
      : 'ОСГПО (Автоцивилка) в Одессе - Онлайн Оформление Страховки | FinRadar',
    description: params.lang === 'uk'
      ...
      : 'Оформить ОСГПО (автогражданку) в Одессе онлайн. Сравнение цен от всех страховых компаний Одессы. Электронный полис за 5 минут. Цены от 4 308 грн.',
