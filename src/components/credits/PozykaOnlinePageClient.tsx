...
interface PozykaOnlinePageClientProps {
  lang: Locale;
}

export default function PozykaOnlinePageClient({ lang }: PozykaOnlinePageClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b">
        <div className="container-custom py-4">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            <Link href={`/${lang}`} className="hover:text-purple-600">
              {lang === 'uk' ? 'Головна' : 'Главная'}
            </Link>
            <span>/</span>
            <Link href={`/${lang}/credits`} className="hover:text-purple-600">
              {lang === 'uk' ? 'Кредити' : 'Кредиты'}
            </Link>
            <span>/</span>
            <span className="text-gray-900">{lang === 'uk' ? 'Позика онлайн' : 'Займ онлайн'}</span>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold font-heading mb-2">
                {lang === 'uk' ? 'Позика онлайн' : 'Займ онлайн'} {lang === 'uk' ? 'України' : 'Украины'} 2026
              </h1>
              <p className="text-xl text-purple-100">
                {sortedLoans.length} {lang === 'uk' ? 'пропозицій на вигідних умовах' : 'предложений на выгодных условиях'}
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 overflow-x-auto">
            <div className="flex gap-2 min-w-max">
              ...
              <Link
                ...
                className="bg-white text-purple-600 px-4 py-2 rounded-lg font-semibold whitespace-nowrap"
              >
      ...
      <div className="container-custom py-8">
                    ...
                    >
                      <div className="p-6">
                        ...
                        <div className="flex gap-3">
                          ...
                          >
                            {lang === 'uk' ? 'Отримати кредит' : 'Оформить кредит'}
                          </a>
                          <Link
        ...
        {/* Bottom CTA */}
        <div className="mt-12 bg-gradient-to-r from-purple-600 via-indigo-600 to-purple-700 rounded-2xl p-8 md:p-12 text-white text-center">
          ...
          <p className="text-lg text-purple-100 mb-6 max-w-2xl mx-auto">
            {lang === 'uk'
              ? 'Наші фахівці підберуть найвигідніший варіант позики під ваші потреби та можливості'
              : 'Наши специалисты подберут самый выгодный вариант займа под ваши нужды и возможности'
            }
          </p>
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <div className="mb-8">
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.pozykaOnlineArticle.intro}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.pozykaOnlineArticle.introParagraph2}
              </p>
            </div>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.pozykaOnlineArticle.howToGetTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.pozykaOnlineArticle.howToGetContent}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.pozykaOnlineArticle.howToGetParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.pozykaOnlineArticle.noRefusalTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.pozykaOnlineArticle.noRefusalContent}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.pozykaOnlineArticle.noRefusalParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.pozykaOnlineArticle.badCreditTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.pozykaOnlineArticle.badCreditContent}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.pozykaOnlineArticle.badCreditParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.pozykaOnlineArticle.fastCreditTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.pozykaOnlineArticle.fastCreditContent}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.pozykaOnlineArticle.fastCreditParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.pozykaOnlineArticle.advantagesTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.pozykaOnlineArticle.advantagesContent}
              </p>
              <ul className="list-disc list-inside space-y-2 mb-4">
                {dict.pozykaOnlineArticle.advantagesList.map((advantage, index) => (
              ...
              <p className="text-gray-700 leading-relaxed">
                {dict.pozykaOnlineArticle.advantagesParagraph2}
              </p>
            </section>
            ...
            <section className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.pozykaOnlineArticle.conclusionTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed">
                {dict.pozykaOnlineArticle.conclusionContent}
              </p>
            </section>
          </div>
        </article>
