...
interface MfoPageClientProps {
  lang: Locale;
}

export default function MfoPageClient({ lang }: MfoPageClientProps) {
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-emerald-100 text-emerald-700 px-4 py-2 rounded-full text-sm font-semibold mb-4">
            ...
            {lang === 'uk' ? 'Перевірені організації' : 'Проверенные организации'}
          </div>
          <h1 className="text-4xl md:text-5xl font-bold font-heading text-gray-900 mb-4">
            {lang === 'uk' ? 'МФО - тільки перевірені організації в Україні' : 'МФО - только проверенные организации в Украине'}
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            {lang === 'uk'
              ? 'Всі МФО України в одному місці! Кредити МФО онлайн на карту без довідок 24/7'
              : 'Все МФО Украины в одном месте! Кредиты МФО онлайн на карту без справок 24/7'
            }
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm text-center">
            <div className="text-3xl font-bold text-emerald-600 mb-2">5 хв</div>
            <div className="text-sm text-gray-600">
                ...
                return (
                  <div
                    ...
                    className={`bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow p-6 ${
                      loan.recommended ? 'ring-2 ring-emerald-500' : ''
                    }`}
                  >
                    {loan.recommended && (
                      <div className="inline-flex items-center gap-1 bg-emerald-100 text-emerald-700 px-3 py-1 rounded-full text-sm font-semibold mb-4">
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="flex gap-3">
                          ...
                          <Link
                            href={`/${lang}/credits/mfo/${loan.id}`}
                            className="px-6 py-3 border-2 border-emerald-600 text-emerald-600 rounded-lg font-semibold hover:bg-emerald-600 hover:text-white transition-colors text-center"
                          >
        ...
        {/* Bottom CTA */}
        <div className="mt-12 bg-gradient-to-r from-emerald-600 via-green-600 to-emerald-600 rounded-2xl p-8 md:p-12 text-white text-center">
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <div className="mb-8">
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.mfoArticle.intro}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.mfoArticle.introParagraph2}
              </p>
            </div>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.mfoArticle.whatIsTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.mfoArticle.whatIsContent}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.mfoArticle.whatIsParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.mfoArticle.allMfoTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.mfoArticle.allMfoContent}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.mfoArticle.allMfoParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.mfoArticle.howItWorksTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.mfoArticle.howItWorksContent}
              </p>
              <ul className="list-none space-y-2 mb-4">
                {dict.mfoArticle.howItWorksList.map((item, idx) => (
              ...
              <p className="text-gray-700 leading-relaxed">
                {dict.mfoArticle.howItWorksParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.mfoArticle.refinancingTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.mfoArticle.refinancingContent}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.mfoArticle.refinancingParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.mfoArticle.duringWarTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.mfoArticle.duringWarContent}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.mfoArticle.duringWarParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                <Star className="w-6 h-6 text-emerald-600" />
                {dict.mfoArticle.advantagesTitle}
              </h2>
              <ul className="list-none space-y-2">
                {dict.mfoArticle.advantagesList.map((advantage, idx) => (
                  <li key={idx} className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-emerald-600 mt-0.5 flex-shrink-0" />
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.mfoArticle.howToChooseTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.mfoArticle.howToChooseContent}
              </p>
              <ul className="list-none space-y-2">
                {dict.mfoArticle.howToChooseList.map((item, idx) => (
                  <li key={idx} className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-emerald-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">{item}</span>
                  </li>
            ...
            {/* Conclusion */}
            <section className="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-xl p-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                {dict.mfoArticle.conclusionTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed">
                {dict.mfoArticle.conclusionContent}
              </p>
            </section>
          </div>
        </article>
        ...
        <nav className="mt-8 text-sm text-gray-600">
          <ol className="flex items-center gap-2">
            <li>
              <Link href={`/${lang}`} className="hover:text-emerald-600">
                {lang === 'uk' ? 'Головна' : 'Главная'}
              </Link>
            </li>
            <li>/</li>
            <li>
              <Link href={`/${lang}/credits`} className="hover:text-emerald-600">
