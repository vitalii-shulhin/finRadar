...
interface Credit247PageClientProps {
  lang: Locale;
}

export default function Credit247PageClient({ lang }: Credit247PageClientProps) {
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-teal-100 text-teal-700 px-4 py-2 rounded-full text-sm font-semibold mb-4">
            ...
            {lang === 'uk' ? 'Працюємо цілодобово' : 'Работаем круглосуточно'}
          </div>
          <h1 className="text-4xl md:text-5xl font-bold font-heading text-gray-900 mb-4">
            {lang === 'uk' ? 'Кредит онлайн 24/7 цілодобово' : 'Кредит онлайн 24/7 круглосуточно'}
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            {lang === 'uk'
              ? 'Отримайте кредит на карту у будь-який час доби! Працюємо 24/7 без вихідних та свят'
              : 'Получите кредит на карту в любое время суток! Работаем 24/7 без выходных и праздников'
            }
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          <div className="bg-white p-6 rounded-xl shadow-sm text-center">
            ...
            <div className="text-sm text-gray-600">
              {lang === 'uk' ? 'Цілодобово' : 'Круглосуточно'}
            </div>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-sm text-center">
            <div className="text-3xl font-bold text-teal-600 mb-2">5 хв</div>
            <div className="text-sm text-gray-600">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm text-center">
            ...
            <div className="text-sm text-gray-600">
              {lang === 'uk' ? 'Перший кредит' : 'Первый кредит'}
            </div>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-sm text-center">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-8">
          ...
          >
            ...
            <ChevronDown className={`w-6 h-6 text-teal-600 transition-transform duration-300 ${showCalculator ? 'rotate-180' : ''}`} />
          </button>
                ...
                return (
                  <div
                    ...
                    className={`bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow p-6 ${
                      loan.recommended ? 'ring-2 ring-teal-500' : ''
                    }`}
                  >
                    {loan.recommended && (
                      <div className="inline-flex items-center gap-1 bg-teal-100 text-teal-700 px-3 py-1 rounded-full text-sm font-semibold mb-4">
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex-grow w-full">
                        ...
                        <div className="flex gap-3">
                          ...
                          <Link
                            href={`/${lang}/credits/credit-24-7/${loan.id}`}
                            className="px-6 py-3 border-2 border-teal-600 text-teal-600 rounded-lg font-semibold hover:bg-teal-600 hover:text-white transition-colors text-center"
                          >
        ...
        {/* Bottom CTA */}
        <div className="mt-12 bg-gradient-to-r from-teal-600 via-blue-600 to-teal-600 rounded-2xl p-8 md:p-12 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href={`/${lang}/calc/credit`} className="bg-white text-teal-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
              {lang === 'uk' ? 'Всі кредити' : 'Все кридиты'}
            </Link>
            {/*<button className="bg-transparent border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-teal-600 transition-colors">*/}
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <div className="mb-8">
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.credit247Article.intro}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.credit247Article.introParagraph2}
              </p>
            </div>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.credit247Article.whatIsTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.credit247Article.whatIsContent}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.credit247Article.whatIsParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.credit247Article.howToGetTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.credit247Article.howToGetContent}
              </p>
              <ul className="list-none space-y-2 mb-4">
                {dict.credit247Article.howToGetList.map((item, idx) => (
              ...
              <p className="text-gray-700 leading-relaxed">
                {dict.credit247Article.howToGetParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.credit247Article.cardAroundClockTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.credit247Article.cardAroundClockContent}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.credit247Article.cardAroundClockParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.credit247Article.advantagesTitle}
              </h2>
              <ul className="list-none space-y-2">
                {dict.credit247Article.advantagesList.map((advantage, idx) => (
                  <li key={idx} className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-teal-600 mt-0.5 flex-shrink-0" />
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.credit247Article.whoSuitsTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.credit247Article.whoSuitsContent}
              </p>
              <ul className="list-none space-y-2">
                {dict.credit247Article.whoSuitsList.map((item, idx) => (
                  <li key={idx} className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">{item}</span>
                  </li>
            ...
            <section className="bg-gradient-to-r from-teal-50 to-blue-50 rounded-xl p-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                {dict.credit247Article.conclusionTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed">
                {dict.credit247Article.conclusionContent}
              </p>
            </section>
          </div>
        </article>
        ...
        <nav className="mt-8 text-sm text-gray-600">
          <ol className="flex items-center gap-2">
            <li>
              <Link href={`/${lang}`} className="hover:text-teal-600">
                {lang === 'uk' ? 'Головна' : 'Главная'}
              </Link>
            </li>
            <li>/</li>
            <li>
              <Link href={`/${lang}/credits`} className="hover:text-teal-600">
                {lang === 'uk' ? 'Кредити' : 'Кредиты'}
              </Link>
            </li>
            <li>/</li>
            <li className="text-gray-900 font-semibold">
              {lang === 'uk' ? 'Кредит 24/7' : 'Кредит 24/7'}
            </li>
          </ol>
        </nav>
      </div>
