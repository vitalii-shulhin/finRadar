...
interface MfoReytyngPageClientProps {
  lang: Locale;
}

export default function MfoReytyngPageClient({ lang }: MfoReytyngPageClientProps) {
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-emerald-100 text-emerald-700 px-4 py-2 rounded-full text-sm font-semibold mb-4">
            ...
            {lang === 'uk' ? 'ТОП МФО' : 'ТОП МФО'}
          </div>
          <h1 className="text-4xl md:text-5xl font-bold font-heading text-gray-900 mb-4">
            {lang === 'uk' ? 'Рейтинг МФО України' : 'Рейтинг МФО Украины'}
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            {lang === 'uk'
              ? 'Топ кращі МФО України! Рейтинг мікрофінансових організацій з вигідними умовами та високим шансом схвалення'
              : 'Топ лучшие МФО Украины! Рейтинг микрофинансовых организаций с выгодными условиями и высоким шансом одобрения'
            }
          </p>
        </div>
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <div className="mb-8">
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.mfoReytyngArticle.intro}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.mfoReytyngArticle.introParagraph2}
              </p>
            </div>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.mfoReytyngArticle.topMfoTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.mfoReytyngArticle.topMfoContent}
              </p>
              <ul className="list-none space-y-2">
                {dict.mfoReytyngArticle.topMfoList.map((item, idx) => (
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.mfoReytyngArticle.howRatingTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.mfoReytyngArticle.howRatingContent}
              </p>
              <ul className="list-none space-y-2">
                {dict.mfoReytyngArticle.howRatingList.map((item, idx) => (
                  <li key={idx} className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-emerald-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">{item}</span>
                  </li>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.mfoReytyngArticle.howToChooseTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.mfoReytyngArticle.howToChooseContent}
              </p>
              <ul className="list-none space-y-2">
                {dict.mfoReytyngArticle.howToChooseList.map((item, idx) => (
                  <li key={idx} className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-emerald-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">{item}</span>
                  </li>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.mfoReytyngArticle.advantagesTitle}
              </h2>
              <ul className="list-none space-y-2">
                {dict.mfoReytyngArticle.advantagesList.map((advantage, idx) => (
                  <li key={idx} className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-emerald-600 mt-0.5 flex-shrink-0" />
            ...
            <section className="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-xl p-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                {dict.mfoReytyngArticle.conclusionTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed">
                {dict.mfoReytyngArticle.conclusionContent}
              </p>
            </section>
          </div>
        </article>
        ...
        <nav className="mt-8 text-sm text-gray-600">
          <ol className="flex items-center gap-2">
            ...
            <li>/</li>
            <li>
              <Link href={`/${lang}/credits/mfo`} className="hover:text-emerald-600">
                {lang === 'uk' ? 'МФО' : 'МФО'}
              </Link>
            </li>
            <li>/</li>
            <li className="text-gray-900 font-semibold">
              {lang === 'uk' ? 'Рейтинг МФО' : 'Рейтинг МФО'}
            </li>
          </ol>
        </nav>
      </div>
