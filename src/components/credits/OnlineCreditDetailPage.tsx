          ...
          <div className="relative bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-3xl p-8 sm:p-12 overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl text-white/90 font-semibold mb-3">{product.productName}</p>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-1 bg-green-400 px-3 py-1 rounded-full">
                        <CheckCircle className="w-4 h-4 text-gray-900" />
                        <span className="text-gray-900 font-bold">{product.approvalRate}%</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                <div className="bg-white/20 backdrop-blur-md rounded-xl p-4 border-2 border-white/30 hover:bg-white/25 transition-all hover:scale-105">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-8">
                ...
                {product.website && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 border-2 border-white/30 text-white px-8 py-5 rounded-xl font-black text-xl hover:scale-105 transition-all shadow-xl hover:shadow-2xl flex items-center justify-center gap-2"
                  >
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 sticky top-6">
              ...
              <div className="space-y-4">
                {product.phone && (
                  <a
                    ...
                    className="flex items-center gap-3 p-4 bg-indigo-100 rounded-xl hover:bg-indigo-50 hover:border-indigo-200 border-2 border-transparent transition-all"
                  >
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-xl p-4 border border-emerald-100">
                  ...
                  <div className="text-2xl font-black text-emerald-600">{product.approvalRate}%</div>
                </div>
                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-4 border border-blue-100">
                  <div className="text-xs text-gray-600 mb-1">
                    {lang === 'uk' ? 'Рейтинг' : 'Рейтинг'}
                  </div>
                  <div className="text-2xl font-black text-blue-600">{product.rating}</div>
                </div>
              </div>
