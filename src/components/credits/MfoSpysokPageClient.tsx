...
interface MfoSpysokPageClientProps {
  lang: Locale;
}

export default function MfoSpysokPageClient({ lang }: MfoSpysokPageClientProps) {
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-emerald-100 text-emerald-700 px-4 py-2 rounded-full text-sm font-semibold mb-4">
            ...
            {lang === 'uk' ? 'Повний список' : 'Полный список'}
          </div>
          <h1 className="text-4xl md:text-5xl font-bold font-heading text-gray-900 mb-4">
            {lang === 'uk' ? 'Список МФО України' : 'Список МФО Украины'}
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            {lang === 'uk'
              ? 'Повний перелік всіх МФО! Список мікрозаймів онлайн - кредит онлайн список МФО України'
              : 'Полный перечень всех МФО! Список микрозаймов онлайн - кредит онлайн список МФО Украины'
            }
          </p>
        </div>
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <div className="mb-8">
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.mfoSpysokArticle.intro}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.mfoSpysokArticle.introParagraph2}
              </p>
            </div>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.mfoSpysokArticle.listMfoTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.mfoSpysokArticle.listMfoContent}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.mfoSpysokArticle.listMfoParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.mfoSpysokArticle.howToUseTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.mfoSpysokArticle.howToUseContent}
              </p>
              <ul className="list-none space-y-2">
                {dict.mfoSpysokArticle.howToUseList.map((item, idx) => (
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.mfoSpysokArticle.differenceTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.mfoSpysokArticle.differenceContent}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.mfoSpysokArticle.differenceParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.mfoSpysokArticle.advantagesTitle}
              </h2>
              <ul className="list-none space-y-2">
                {dict.mfoSpysokArticle.advantagesList.map((advantage, idx) => (
                  <li key={idx} className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-emerald-600 mt-0.5 flex-shrink-0" />
            ...
            <section className="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-xl p-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                {dict.mfoSpysokArticle.conclusionTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed">
                {dict.mfoSpysokArticle.conclusionContent}
              </p>
            </section>
          </div>
        </article>
