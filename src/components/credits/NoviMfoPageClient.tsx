...
interface NoviMfoPageClientProps {
  lang: Locale;
}

export default function NoviMfoPageClient({ lang }: NoviMfoPageClientProps) {
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-cyan-100 text-cyan-700 px-4 py-2 rounded-full text-sm font-semibold mb-4">
            ...
            {lang === 'uk' ? 'Свіжі пропозиції' : 'Свежие предложения'}
          </div>
          <h1 className="text-4xl md:text-5xl font-bold font-heading text-gray-900 mb-4">
            {lang === 'uk' ? 'Нові МФО' : 'Новые МФО'}
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            {lang === 'uk'
              ? 'Маловідомі МФО з високим шансом схвалення. Нові мікрозайми без відмов та перевірки кредитної історії!'
              : 'Малоизвестные МФО с высоким шансом одобрения. Новые микрозаймы без отказов и проверки кредитной истории!'
            }
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-8">
          ...
          {/* Results Count */}
          <div className="text-center py-4 bg-cyan-50 rounded-lg">
                ...
                return (
                  <div
                    ...
                    className={`bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow p-6 ${
                      loan.recommended ? 'ring-2 ring-cyan-500' : ''
                    }`}
                  >
                    {loan.recommended && (
                      <div className="inline-flex items-center gap-1 bg-cyan-100 text-cyan-700 px-3 py-1 rounded-full text-sm font-semibold mb-4">
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex-grow w-full">
                        ...
                        <div className="flex gap-3">
                          ...
                          <Link
                            href={`/${lang}/credits/novi-mfo/${loan.id}`}
                            className="px-6 py-3 border-2 border-cyan-600 text-cyan-600 rounded-lg font-semibold hover:bg-cyan-600 hover:text-white transition-colors text-center"
                          >
        ...
        {/* Bottom CTA */}
        <div className="mt-12 bg-gradient-to-r from-cyan-600 via-blue-600 to-cyan-600 rounded-2xl p-8 md:p-12 text-white text-center">
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <div className="mb-8">
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.noviMfoArticle.intro}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.noviMfoArticle.introParagraph2}
              </p>
            </div>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.noviMfoArticle.whyChooseTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.noviMfoArticle.whyChooseContent}
              </p>
              <ul className="list-none space-y-2 mb-4">
                {dict.noviMfoArticle.whyChooseList.map((item, idx) => (
              ...
              <p className="text-gray-700 leading-relaxed">
                {dict.noviMfoArticle.whyChooseParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.noviMfoArticle.noRefusalsTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.noviMfoArticle.noRefusalsContent}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.noviMfoArticle.noRefusalsParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.noviMfoArticle.noCheckTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.noviMfoArticle.noCheckContent}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.noviMfoArticle.noCheckParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.noviMfoArticle.lesserKnownTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.noviMfoArticle.lesserKnownContent}
              </p>
              <p className="text-gray-700 leading-relaxed">
                {dict.noviMfoArticle.lesserKnownParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.noviMfoArticle.howToChooseTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                {dict.noviMfoArticle.howToChooseContent}
              </p>
              <ul className="list-none space-y-2 mb-4">
                {dict.noviMfoArticle.howToChooseList.map((item, idx) => (
                  <li key={idx} className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-cyan-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">{item}</span>
                  </li>
              ...
              <p className="text-gray-700 leading-relaxed">
                {dict.noviMfoArticle.howToChooseParagraph2}
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                ...
                {dict.noviMfoArticle.advantagesTitle}
              </h2>
              <ul className="list-none space-y-2">
                {dict.noviMfoArticle.advantagesList.map((advantage, idx) => (
                  <li key={idx} className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-cyan-600 mt-0.5 flex-shrink-0" />
            ...
            <section className="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl p-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                {dict.noviMfoArticle.conclusionTitle}
              </h2>
              <p className="text-gray-700 leading-relaxed">
                {dict.noviMfoArticle.conclusionContent}
              </p>
            </section>
          </div>
        </article>
        ...
        <nav className="mt-8 text-sm text-gray-600">
          <ol className="flex items-center gap-2">
            <li>
              <Link href={`/${lang}`} className="hover:text-cyan-600">
                {lang === 'uk' ? 'Головна' : 'Главная'}
              </Link>
            </li>
            <li>/</li>
            <li>
              <Link href={`/${lang}/credits`} className="hover:text-cyan-600">
